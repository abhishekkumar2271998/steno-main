...
// Load environment variables (including secrets) from .env file
...
const GOOGLE_SCOPES = process.env.GOOGLE_SCOPES || 'https://www.googleapis.com/auth/calendar.readonly';
...
const OUTLOOK_SCOPES = process.env.OUTLOOK_SCOPES || 'Calendars.Read offline_access';
const OUTLOOK_AUTH_URL = process.env.OUTLOOK_AUTH_URL || 'https://login.microsoftonline.com/common/oauth2/v2.0/authorize';
const OUTLOOK_TOKEN_URL = process.env.OUTLOOK_TOKEN_URL || 'https://login.microsoftonline.com/common/oauth2/v2.0/token';
